          ...
          <div className="flex items-center gap-7 md:gap-4">
            {isAdmin && (
              <>
                ...
                >
                  <span className=" hidden md:block mr-1">الخلايا</span>
                  <svg
...
<button className="flex items-center gap-2"  onClick={() => setShowEvent(true)}>
              <span className="hidden md:block mr-1"> إضافة حدث</span>
